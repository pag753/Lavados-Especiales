  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(); ?>index.php/administracion/nuevoProceso" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(); ?>index.php/administracion/editarProceso" method="post" enctype="multipart/form-data">
