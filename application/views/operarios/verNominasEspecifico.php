    ...
    <form action="verNominas" method="post" class="col-12" target="_blank">
      ...
      <div class="card col-md-6 col-lg-6 offset-md-3 col-lg-3">
        <div class="card-header">
          <div class="mx-auto">
            <a data-toggle="collapse" href="#especificos" role="button" aria-expanded="false" aria-controls="especificos"> <strong>Datos específicos de la nómina.</strong>
            </a>
          </div>
        </div>
      ...
      <div class="card col-12">
        <div class="card-header">
          <div class="mx-auto">
            <a data-toggle="collapse" href="#produccion" role="button" aria-expanded="false" aria-controls="produccion"> <strong>Datos de la producción en proceso seco.</strong></a>
          </div>
        </div>
        <div class="collapse" id="produccion">
          <div class="card-body">
            ...
            <?php else: ?>
              <div class="alert alert-danger" role="alert">No existen registros de proceso seco</div>
            <?php endif; ?>
          </div>
        </div>
      </div>
      <div class="card col-12">
        <div class="card-header">
          <div class="mx-auto">
            <a data-toggle="collapse" href="#reprocesos" role="button" aria-expanded="false" aria-controls="reprocesos"><strong>Datos de la producción de reprocesos.</strong></a>
          </div>
        </div>
