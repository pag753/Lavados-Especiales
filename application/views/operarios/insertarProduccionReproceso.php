        ...
        <table class="table table-striped table-hover" name="tabla" id="tabla" style="background: rgba(255,255,255,0.9)">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input class="form-control" type="number" id="piezas" name="piezas" value="<?php echo $piezas ?>" required>
              </td>
            </tr>
            <tr>
              <th>Número de defectos</th>
              <td>
                <input class="form-control" type="number" id="defectos" name="defectos" value="<?php echo $defectos ?>" required>
              </td>
            </tr>
          </tbody>
        </table>
