...
<div class="container-fluid">
  <div class="row">
    <form action="reporte5" method="post" target="_blank" class="col-12">
      <h3>Reporte de cargas en el almacén de salida.</h3>
      <?php if (count($data) > 0): ?>
            ...
            <tbody>
              <?php foreach ($data as $key => $value): ?>
                <tr>
                  ...
                  <td>
                    <?php echo $value['carga'] . "    " . $value['lavado'] ?>
                    <input type="hidden" name="lavado[<?php echo $contador;?>]" value="<?php echo $value['carga'] . "   " . $value['lavado'] ?>">
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <input type="hidden" name="fecha[<?php echo $contador; $contador ++; ?>]" value="<?php echo $value['fecha'] ?>">
                  </td>
